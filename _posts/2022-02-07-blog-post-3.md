...
This is the link to my github respository. 
[https://github.com/xinyudong1129/Blog-Post/tree/main/blogpost3](https://github.com/xinyudong1129/Blog-Post/tree/main/blogpost3)

(1)First, We start from the starting IMDB page of Harry Potter
...
df1 = df.groupby("Movie_or_TV_name").size().reset_index(name="Number of shared actors")
...
From the result, I like Harry Potter and the Sorcerer's Stone, maybe I like the harry potter series! It's resonable.
The top three is Harry Potter and the Sorcerer's Stone, Harry Potter and the Order of the Phoenix and Harry Potter and the Chamber of Secrets.
